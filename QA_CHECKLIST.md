...
| **11** | **Acciones** | Validación de Formato HEX | 1. Ingresar un texto aleatorio en el campo de color (ej: "rojo" o "123").<br>2. Intentar crear la acción. | El sistema muestra un mensaje de error indicando que el formato HEX es inválido. |
